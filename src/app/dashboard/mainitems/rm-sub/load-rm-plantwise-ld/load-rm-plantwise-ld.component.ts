...
@Component({
  selector: 'app-load-rm-plantwise-ld',
  templateUrl: './load-rm-plantwise-ld.component.html',
  styleUrls: ['./load-rm-plantwise-ld.component.css'],
  providers: [DatePipe]
})
export class LoadRmPlantwiseLdComponent implements OnInit {
  ...
  loadOtdPlantData(){
    this.http.get(this.apiUrl + 'dashboard/dashboard?type=load-plantwise-rm-ld').subscribe(response => {
      var data = response;
