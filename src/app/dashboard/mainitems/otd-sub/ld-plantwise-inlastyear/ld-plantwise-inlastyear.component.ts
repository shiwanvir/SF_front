...
@Component({
  selector: 'app-ld-plantwise-inlastyear',
  templateUrl: './ld-plantwise-inlastyear.component.html',
  styleUrls: ['./ld-plantwise-inlastyear.component.css'],
    providers: [DatePipe]
})
export class LdPlantwiseInlastyearComponent implements OnInit {
  ...
  loadOtdPlantData(){
    this.http.get(this.apiUrl + 'dashboard/dashboard?type=load-ld-Plantwise-inlastyear').subscribe(response => {
      var data = response;
