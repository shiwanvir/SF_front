...
@Component({
  selector: 'app-inventory-plantwise-lastyear',
  templateUrl: './inventory-plantwise-lastyear.component.html',
  styleUrls: ['./inventory-plantwise-lastyear.component.css'],
  providers: [DatePipe]
})
export class InventoryPlantwiseLastyearComponent implements OnInit {
  ...
  this.http.get(this.apiUrl + 'dashboard/dashboard?type=inventory-plantwise-lasttyear&customer='+this._route.snapshot.queryParamMap.get('id')).subscribe(response => {
      var data = response;
