...
@Component({
  selector: 'app-otd-plantwise-until-currentdat',
  templateUrl: './otd-plantwise-until-currentdat.component.html',
  styleUrls: ['./otd-plantwise-until-currentdat.component.css'],
    providers: [DatePipe]
})
export class OtdPlantwiseUntilCurrentdatComponent implements OnInit {
  ...
  loadOtdPlantData(){
    this.http.get(this.apiUrl + 'dashboard/dashboard?type=load-Otd-Plantwise-until-currentdate').subscribe(response => {
      var data = response;
