...
@Component({
  selector: 'app-load-rm-plantwise-otd-tocurrent',
  templateUrl: './load-rm-plantwise-otd-tocurrent.component.html',
  styleUrls: ['./load-rm-plantwise-otd-tocurrent.component.css'],
  providers: [DatePipe]
})
export class LoadRmPlantwiseOtdTocurrentComponent implements OnInit {
