...
@Component({
  selector: 'app-load-rm-plantwise-otd',
  templateUrl: './load-rm-plantwise-otd.component.html',
  styleUrls: ['./load-rm-plantwise-otd.component.css'],
  providers: [DatePipe]
})
export class LoadRmPlantwiseOtdComponent implements OnInit {
  ...
  loadOtdPlantData(){
    this.http.get(this.apiUrl + 'dashboard/dashboard?type=load-plantwise-rm-otd').subscribe(response => {
      var data = response;
