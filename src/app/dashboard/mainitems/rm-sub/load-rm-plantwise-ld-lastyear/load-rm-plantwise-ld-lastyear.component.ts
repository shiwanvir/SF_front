...
@Component({
  selector: 'app-load-rm-plantwise-ld-lastyear',
  templateUrl: './load-rm-plantwise-ld-lastyear.component.html',
  styleUrls: ['./load-rm-plantwise-ld-lastyear.component.css'],
  providers: [DatePipe]
})
export class LoadRmPlantwiseLdLastyearComponent implements OnInit {
  ...
  loadOtdPlantData(){
    this.http.get(this.apiUrl + 'dashboard/dashboard?type=load-plantwise-lastyear-rm-ld').subscribe(response => {
      var data = response;
