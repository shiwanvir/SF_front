...
@Component({
  selector: 'app-quarterin-last-two-year',
  templateUrl: './quarterin-last-two-year.component.html',
  styleUrls: ['./quarterin-last-two-year.component.css'],
  providers: [DatePipe]
})
export class QuarterinLastTwoYearComponent implements OnInit {

  anio:number = new Date().getFullYear()-2;
