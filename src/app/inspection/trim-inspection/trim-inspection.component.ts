...
@Component({
  selector: 'app-trim-inspection',
  templateUrl: './trim-inspection.component.html',
  styleUrls: ['./trim-inspection.component.css']
})
export class TrimInspectionComponent implements OnInit{
    ...
    constructor(private http:HttpClient , private fb:FormBuilder, private titleService: Title,private hotRegisterer: HotTableRegisterer,
      private layoutChangerService : LayoutChangerService,private inspectionService:TrimInspectionService,private permissionService : PermissionsService) {
    ...
    //debugger
        this.titleService.setTitle("Trim inspection")//set page title
      ...
      this.inspectionService.triminspectionData.subscribe(data=>{
      //debugger()
      if(data!=null){
     ...
     ngOnDestroy() {
      ...
      formValidate(){ //validate the form on input blur event
        ...
        //var sheetclip = new sheetclip();
          this.hotOptionsRollPlan = {
            ...
            /*  { type: 'checkbox', title : 'Action' , readOnly: false, data : 'connected' , checkedTemplate: 1,  uncheckedTemplate: 0 },*/
              ...
              { type: 'text', title : 'Box No' , data: 'roll_or_box_no',readOnly:true},
            ...
            /*  { type: 'text', title : 'Spec Width' , data: 'width',readOnly:false},*/
            ...
            this.statusValidation(surce)
              ...
              //this.stylewiseTotalSMV(surce);
               ...
               if(surce[0][1]=='qty'){
                 ...
                 this.datasetRollPlan[_row]['qty']=_qty
                 hotInstance.render()
               }
        ...
        searchTrimPackingDetails(){
          ...
          this.http.get(this.apiUrl + 'stores/searchTrimPackingDetails?invoiceNo='+formData.invoice_no+'&batchNo='+formData.batch_no+'&itemCode='+formData.item_code)
       ...
       .subscribe(data=>{
        ...
        //debugger
          ...
          for(var i=0;i<this.datasetRollPlan.length;i++){
            totQty=parseFloat(this.datasetRollPlan[i]['actual_qty']+totQty);
            ...
            if(this.datasetRollPlan[i]['lab_comment']==undefined){
        ...
        /*  if(totQty!=parseFloat(this.datasetRollPlan[0]['grn_qty'])){
          ...
          */
          ...
          let saveOrUpdate$ = null;
            ...
            saveOrUpdate$ = this.http.post(this.apiUrl + 'store/trimInspection', {data:this.datasetRollPlan})
          }
          else if(formData.id!=0){
            saveOrUpdate$ = this.http.put(this.apiUrl + 'store/trimInspection/'+ formData.id,{data:this.datasetRollPlan})
          }
          ...
          confirmInspection(){
           this.inspectionConfirmed=true;
            var i=0;
                           ...
                           'text' : 'Do you want to confirm Trim Inspection?'
                         },
                         ...
                         (result) => {
                            if (result.value) {
                             ...
                             this.http.post(this.apiUrl + 'stores/confrimTrimInspection',{'dataset':this.datasetRollPlan})
                             .pipe( map(res => res['data']) )
                             .subscribe(
                                 (data) => {
                                   if(data.status==1)
