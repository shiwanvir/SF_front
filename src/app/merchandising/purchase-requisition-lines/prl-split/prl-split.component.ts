...
@Component({
  selector: 'app-prl-split',
  templateUrl: './prl-split.component.html',
  styleUrls: ['./prl-split.component.css']
})
export class PrlSplitComponent implements OnInit {
  ...
  constructor(private prlService : PrlService, private fb : FormBuilder , private http:HttpClient , private hotRegisterer: HotTableRegisterer)
  { }
  ...
  ngOnInit() {
    ...
    this.prlService.contextMenuSplit.subscribe(data => {
      if(data != null){
        this.dataset = [];
